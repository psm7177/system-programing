...
#define EVT_CACHE_REFS      0x0004 // Replace it with the event number for # of L1 data cache accesses
#define EVT_CPU_CYCLES      0x0011 // Replace it with the event number for # of CPU cycles
